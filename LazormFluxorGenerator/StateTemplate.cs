...
namespace LazormFluxorGenerator {
    ...
    public partial class StateTemplate : StateTemplateBase {
...
string stateClassName = entityClassNamePlural + "State";
            ...
            #line 30 ""
            this.Write("(bool isLoading, string? currentErrorMessage, IEnumerable<");
            ...
            #line 30 ""
            this.Write(this.ToStringHelper.ToStringWithCulture( currentEntitiesLocal ));
    ...
    public class StateTemplateBase {
