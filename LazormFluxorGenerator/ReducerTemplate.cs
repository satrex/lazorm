...
string stateClassName = entityClassNamePlural + "State";
 ...
 if (crud == "Load" ) { 
            ...
            #line 47 ""
            this.Write(" to our list and sort by ID\n            currentEntities.Add(action.");
            ...
            #line 58 ""
            this.Write(" list is null, set the state with a new list containing the updated ");
